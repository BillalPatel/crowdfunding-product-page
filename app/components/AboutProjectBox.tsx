...
export function AboutProjectBox() {
  return (
    <div className="flex flex-col justify-items-center justify-center border-solid border-slate-800 bg-white rounded-lg shadow-lg px-10 mx-auto w-10/12 text-center my-3 lg:w-2/4">
      <div className="container py-10">
        <h1 className="h-14 font-semibold text-lg text-left">
          About this project
        </h1>
        <div className="text-sm text-[#7a7a7a] font-thin text-justify leading-7">
          <p>
      ...
      <div className="container-pledge-boxes flex flex-col space-y-6">
        <PledgeBox
          title="Bamboo Stand"
          pledgeAmount="25"
